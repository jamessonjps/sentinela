...
export function DAASQualityCard({ boInexistenteCount, totalMvi }: DAASQualityCardProps) {
  ...
  return (
    <div className="glass-card p-5 w-full rounded-2xl relative overflow-hidden flex flex-col justify-between border border-indigo-500/20 bg-indigo-500/5 hover:border-indigo-500/35 transition-all duration-300">
      {/* Background Glow */}
